...
<body>
<a href="/SpringMVC21InternationalizationAndLocalization2/admissionForm.html?siteLanguage=en">English </a> |
<a href="/SpringMVC21InternationalizationAndLocalization2/admissionForm.html?siteLanguage=fr">French
	<h1>${headerMessage}</h1>
	<h3> <spring:message code="label.admissionForm" /> </h3>
	<form:errors path="student1.*" />
	<form action="/SpringMVC21InternationalizationAndLocalization2/submitAdmissionForm.html" method = "post">
