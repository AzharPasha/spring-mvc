...
<p><a href="/SpringMVC32WebServices7/admissionForm.html?siteTheme=green">Green </a> |
   <a href="/SpringMVC32WebServices7/admissionForm.html?siteTheme=red">Red </a></p>

<a href="/SpringMVC32WebServices7/admissionForm.html?siteLanguage=en">English </a> |
<a href="/SpringMVC32WebServices7/admissionForm.html?siteLanguage=fr">French </a>

	<h1>${headerMessage}</h1>
	<h3> <spring:message code="label.admissionForm" /></h3>
	<form:errors path="student1.*" />
	<form action="/SpringMVC32WebServices7/submitAdmissionForm.html" method = "post">
